...
package com.mycompany.exp3_s7_felipe_penaloza;
...
public class Exp3_S7_Felipe_Penaloza {
    ...
    static class Entrada {
        ...
        Entrada(int numero, String ubicacion, double costoBase, double descuentoAplicado, double precioFinal, String tipoCliente, boolean esReserva) {
            this.numero = numero;
        ...
        while (!salir) {
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    default -> System.out.println("Opción inválida. Ingrese un número del 1 al 6.");
                }
        ...
        for (String numStr : nums) {
            try {
                ...
                if (e != null && !e.esReserva) {
                    ...
                    System.out.println("Costo base: $" + e.costoBase);
                    System.out.println("Descuento aplicado: $" + e.descuentoAplicado);
    ...
    static void procesarEntrada(Scanner sc, boolean reserva, int totalEntradasProceso) {
        ...
        if (!reserva && totalEntradasProceso >= 3) {
            double adicional = precioFinal * 0.05;
            descuentoAplicado += adicional;
            precioFinal -= adicional;
        }

        Entrada entrada = new Entrada(contadorEntradas++, ubicacion, precio, descuentoAplicado, precioFinal, tipo, reserva);
