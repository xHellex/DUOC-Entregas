package com.bancoxyz.bffweb.client;
 ...
 * (banco-servicios), consumido siempre por HTTP. No hay dependencia de
 * compilacion entre modulos: si banco-servicios cambia su codigo interno,
 * este BFF ni se recompila ni se redespliega, solo depende del contrato HTTP.
 */
@Component
